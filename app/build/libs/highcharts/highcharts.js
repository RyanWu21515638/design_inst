...
(function (K, a) {
    ...
    K = function () {
        var a = window, A = a.document, y = a.navigator && a.navigator.userAgent || "", E = A && A.createElementNS && !!A.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, G = /(edge|msie|trident)/i.test(y) && !window.opera, t = !E, g = /Firefox/.test(y), d = g && 4 > parseInt(y.split("Firefox/")[1], 10);
    ...
    (function (a) {
        var A = [], y = a.charts, E = a.doc, G = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], g = this.paths[1], d = [], m = this.now, r = a.length, n;
                if (1 === m)d = this.toD; else if (r === g.length && 1 > m)for (; r--;)n = parseFloat(a[r]), d[r] = isNaN(n) ? a[r] : m * parseFloat(g[r] - n) + n; else d = g;
                this.elem.attr("d", d)
            }, update: function () {
                var a = this.elem, g = this.prop, d = this.now, m = this.options.step;
                if (this[g + "Setter"])this[g + "Setter"](); else a.attr ? a.element && a.attr(g, d) : a.style[g] = d +
                    this.unit;
                m && m.call(a, d, this)
            }, run: function (a, g, d) {
                var m = this, r = function (a) {
                ...
                var g = +new Date, d, m = this.options;
                d = this.elem;
                var r = m.complete, n = m.duration, p = m.curAnim, b;
                if (d.attr && !d.element)d = !1; else if (a ||
                    g >= n + this.startTime) {
                    this.now = this.end;
                    this.pos = 1;
                    this.update();
                ...
                g = g || "";
                var p, b = t.startX, k = t.endX, v = -1 < g.indexOf("C"), B = v ? 7 : 3, e, c, l;
                g = g.split(" ");
                d = d.slice();
                var q = t.isArea, h = q ? 2 : 1, f;
                v && (m(g), m(d));
                if (b && k) {
        ...
        a.merge = function () {
            var t, g = arguments, d, m = {}, r = function (n, d) {
                var b, k;
                "object" !== typeof n && (n = {});
        ...
        a.attr =
            function (t, g, d) {
                var m, r;
                if (a.isString(g))a.defined(d) ? t.setAttribute(g, d) : t && t.getAttribute && (r = t.getAttribute(g)); else if (a.defined(g) && a.isObject(g))for (m in g)t.setAttribute(m, g[m]);
                return r
            };
        a.splat = function (t) {
        ...
        a.pick = function () {
            var a = arguments, g, d, m = a.length;
        ...
        a.createElement = function (t, g, d, m, r) {
            ...
            var n = a.css;
            g && a.extend(t, g);
            r && n(t, {padding: 0, border: "none", margin: 0});
            d && n(t, d);
            m && m.appendChild(t);
            return t
        };
        ...
        a.dateFormat = function (t, g, d) {
            ...
            var m = a.Date, r = new m(g - a.getTZOffset(g)), n, p = r[m.hcGetHours](), b = r[m.hcGetDay](), k = r[m.hcGetDate](), v = r[m.hcGetMonth](), B = r[m.hcGetFullYear](), e = a.defaultOptions.lang,
                c = e.weekdays, l = e.shortWeekdays, q = a.pad, m = a.extend({
        ...
        a.formatSingle = function (t,
                                   g) {
            var d = /\.([0-9])/, m = a.defaultOptions.lang;
        ...
        a.animObject = function (t) {
            return a.isObject(t) ? a.merge(t) : {duration: t ? 500 : 0}
        };
        a.timeUnits = {
            millisecond: 1,
            second: 1E3,
        ...
        a.numberFormat = function (t, g, d, m) {
            t = +t || 0;
            g = +g;
            var r = a.defaultOptions.lang, n = (t.toString().split(".")[1] || "").length, p, b, k = Math.abs(t);
        ...
        a.fireEvent = function (t, g, d, m) {
            ...
            if (E.createEvent && (t.dispatchEvent || t.fireEvent))r = E.createEvent("Events"), r.initEvent(g, !0, !0), a.extend(r, d), t.dispatchEvent ?
                t.dispatchEvent(r) : t.fireEvent(g, r); else if (r)for (r = r[g] || [], n = r.length, d.target || a.extend(d, {
        ...
        a.animate = function (t, g, d) {
            var m, r = "", n, p, b;
            a.isObject(d) || (m = arguments, d = {duration: m[2], easing: m[3], complete: m[4]});
        ...
        a.seriesType = function (t, g, d, m, r) {
            var n = a.getOptions(), p = a.seriesTypes;
            n.plotOptions[t] = a.merge(n.plotOptions[g], d);
            p[t] = a.extendClass(p[g] || function () {
                }, m);
        ...
        E && !E.defaultView && (a.getStyle = function (t, g) {
            var d;
            d = {width: "clientWidth", height: "clientHeight"}[g];
    ...
    (function (a) {
        ...
        a.Color.prototype = {
            parsers: [{
                ...
                var d = this.input, m = this.rgba, r;
    ...
    (function (a) {
        var A, y, E = a.addEvent, G = a.animate, t = a.attr, g = a.charts, d = a.color, m = a.css, r = a.createElement,
            n = a.defined, p = a.deg2rad, b = a.destroyObjectProperties, k = a.doc, v = a.each, B = a.extend, e = a.erase, c = a.grep, l = a.hasTouch, q = a.isArray, h = a.isFirefox, f = a.isMS, u = a.isObject, D = a.isString, H = a.isWebKit, F = a.merge, I = a.noop, C = a.pick, w = a.pInt, J = a.removeEvent, M = a.stop, x = a.svg, z = a.SVG_NS, N = a.win;
        ...
        A.prototype = {
            ...
            colorGradient: function (O, f, L) {
                var c = this.renderer, x, z, e, u, b, h, l, D, d, C, k, w = [], H;
                ...
                if (z) {
                    ...
                    l = O.stops;
                    C = L.radialReference;
                    q(e) && (O[z] = e = {x1: e[0], y1: e[1], x2: e[2], y2: e[3], gradientUnits: "userSpaceOnUse"});
                    "radialGradient" ===
                    z && C && !n(e.gradientUnits) && (u = e, e = F(e, c.getRadialAttr(C, u), {gradientUnits: "userSpaceOnUse"}));
                    ...
                    b[w] ? C = b[w].attr("id") : (e.id = C = "highcharts-" + a.idCounter++, b[w] = h = c.createElement(z).attr(e).add(c.defs), h.radAttr = u, h.stops = [], v(l, function (O) {
                        ...
                        O = c.createElement("stop").attr({offset: O[0], "stop-color": D, "stop-opacity": d}).add(h);
                        h.stops.push(O)
                    }));
                    H =
                        "url(" + c.url + "#" + C + ")";
            ...
            applyTextShadow: function (a) {
                var c = this.element, L, x = -1 !== a.indexOf("contrast"), z = {}, e = this.renderer.forExport, u = this.renderer.forExport || void 0 !== c.style.textShadow && !f;
            ...
            attr: function (a, f, L) {
                var c, x = this.element, z, e = this, u;
                "string" === typeof a && void 0 !== f &&
                (c = a, a = {}, a[c] = f);
                if ("string" === typeof a)e = (this[a + "Getter"] || this._defaultGetter).call(this, a, x); else {
            ...
            css: function (a) {
                var c = this.styles, L = {}, z = this.element, e, u, b = "";
                e = !c;
            ...
            updateTransform: function () {
                var a = this.translateX || 0, f = this.translateY || 0, c = this.scaleX, x = this.scaleY, z = this.inverted, e = this.rotation, u = this.element;
                z && (a += this.attr("width"),
                    f += this.attr("height"));
                a = ["translate(" + a + "," + f + ")"];
            ...
            getBBox: function (a,
                               c) {
                var x, z = this.renderer, u, e, b, l = this.element, D = this.styles, q = this.textStr, F, d = l.style, k, w = z.cache, H = z.cacheKeys, n;
                e = C(c, this.rotation);
                b = e * p;
                u = D && D.fontSize;
            ...
            add: function (a) {
                var f = this.renderer, c = this.element, x;
            ...
            destroy: function () {
                var a = this.element || {}, f = this.renderer.isSVG && "SPAN" === a.nodeName && this.parentGroup, c, x;
            ...
            shadow: function (a, f, c) {
                var x = [], z, u, e = this.element, b, l, h, D;
            ...
            zIndexSetter: function (a, f) {
                var c = this.renderer, x = this.parentGroup, c = (x || c).element || c.box, z, u, e = this.element, b;
                z = this.added;
                var l;
        ...
        y.prototype = {
            Element: A, SVG_NS: z, init: function (a, f, c, x, z, u) {
                var e;
                x =
                    this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"}).css(this.getStyle(x));
                e = x.element;
                a.appendChild(e);
                -1 === a.innerHTML.indexOf("xmlns") && t(e, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = e;
                this.boxWrapper = x;
                this.alignedObjects = [];
                ...
                h && a.getBoundingClientRect && (this.subPixelFix = f = function () {
                    ...
                    m(a, {left: Math.ceil(b.left) - b.left + "px", top: Math.ceil(b.top) - b.top + "px"})
                }, f(), E(N, "resize", f))
            }, getStyle: function (a) {
                return this.style = B({
                ...
                f.init(this, a);
                return f
            }, draw: I, getRadialAttr: function (a, f) {
                return {
                    cx: a[0] - a[2] / 2 + f.cx *
                ...
                r || -1 !== b.indexOf(" ") ? (D = /<.*class="([^"]+)".*>/, q = /<.*style="([^"]+)".*>/, F = /<.*href="(http[^"]+)".*>/, B && B.appendChild(f), b = l ? b.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [b], b = c(b, function (a) {
                    ...
                    v(l, function (c) {
                        if ("" !== c || 1 === l.length) {
                            var C = {}, w = k.createElementNS(u.SVG_NS, "tspan"), v, J;
                            D.test(c) && (v = c.match(D)[1], t(w, "class", v));
                            q.test(c) && (J = c.match(q)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), t(w, "style", J));
                            F.test(c) && !e && (t(w, "onclick", 'location.href="' + c.match(F)[1] + '"'), m(w, {cursor: "pointer"}));
                ...
                var D = this.label(a, c, x, h, null, null, null, null, "button"), q = 0;
                D.attr(F({padding: 8, r: 2}, u));
                var C, w, d, k;
                u = F({
                    fill: "#f7f7f7",
                    stroke: "#cccccc",
                ...
                w = e.style;
                delete e.style;
                b = F(u, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, b);
                d = b.style;
                delete b.style;
                l = F(u, {style: {color: "#cccccc"}}, l);
                k = l.style;
                delete l.style;
                ...
                D.attr(u).css(B({cursor: "default"}, C));
                ...
                a = u(a) ? a : void 0 === a ? {} : {x: a, y: f, width: Math.max(c, 0), height: Math.max(x, 0)};
                ...
                var x = this.alignedObjects, z = x.length;
                this.width = a;
                this.height = f;
                ...
                1 < arguments.length && B(u, {x: f, y: c, width: x, height: z});
                ...
                var e = this, b, l = this.symbols[a],
                    D = n(f) && l && l(Math.round(f), Math.round(c), x, z, u), h = /^url\((.*?)\)$/, q, w, d = {};
                l ? (b = this.path(D), b.attr("fill", "none"), B(b, {
                    ...
                    x: f,
                    y: c
                }), b.isImg = !0, n(b.imgwidth) && n(b.imgheight) ? w() : (b.attr({width: 0, height: 0}), r("img", {
                    onload: function () {
                        var a = g[e.chartIndex];
                        0 === this.width && (m(this, {position: "absolute", top: "-999em"}), k.body.appendChild(this));
                        d[q] = {width: this.width, height: this.height};
                ...
                circle: function (a, f, c, x) {
                    ...
                    var b = z.end - .001;
                    x = z.innerR;
                    var e = z.open, l = Math.cos(u), D = Math.sin(u), h = Math.cos(b), b = Math.sin(b);
                    ...
                    var u = Math.min(z && z.r || 0, c, x), b = u + 6, e = z && z.anchorX;
                    z = z && z.anchorY;
                    var l;
                ...
                var u = "highcharts-" + a.idCounter++, b = this.createElement("clipPath").attr({id: u}).add(this.defs);
            ...
            text: function (a, f, c, z) {
                ...
                return {x: -a / 3 * Math.sin(f * p), y: x}
            }, label: function (a, f, c, x, z, u, b, e, l) {
                var D = this, h = D.g("button" !== l && "label"), q = h.text = D.text("", 0, 0, b).attr({zIndex: 1}), C, w, d = 0, k = 3, H = 0, r, p, g, N, m, M = {}, I, t, y = /^url\((.*?)\)$/.test(x), E = y, G, K, X, V;
                ...
                X = function () {
                    var a = H + k, f;
                    f = e ? 0 : t;
                    n(r) && w && ("center" === m || "right" === m) && (a += {center: .5, right: 1}[m] *
                        (r - w.width));
                ...
                h.onAdd = function () {
                    q.add(h);
                    h.attr({text: a || 0 === a ? a : "", x: f, y: c});
                    C && n(z) && h.attr({anchorX: z, anchorY: u})
                };
                ...
                return B(h, {
                    css: function (a) {
                        ...
                        return {width: w.width + 2 * k, height: w.height + 2 * k, x: w.x - k, y: w.y - k}
                    }, shadow: function (a) {
                        a && (K(), C && C.shadow(a));
                        return h
                    }, destroy: function () {
    ...
    (function (a) {
        var A = a.attr, y =
            a.createElement, E = a.css, G = a.defined, t = a.each, g = a.extend, d = a.isFirefox, m = a.isMS, r = a.isWebKit, n = a.pInt, p = a.SVGRenderer, b = a.win, k = a.wrap;
        g(a.SVGElement.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a = this.renderer, b = this.element, e = this.translateX || 0, c = this.translateY || 0, l = this.x || 0, q = this.y || 0, h = this.textAlign || "left", f = {
                        left: 0,
                        center: .5,
                        right: 1
                    }[h], u = this.styles;
                    E(b, {marginLeft: e, marginTop: c});
                    this.shadows && t(this.shadows, function (a) {
                        E(a, {marginLeft: e + 1, marginTop: c + 1})
                    });
                    ...
                    if ("SPAN" === b.tagName) {
                        var D =
                            this.rotation, d = n(this.textWidth), k = u && u.whiteSpace, p = [D, h, b.innerHTML, this.textWidth, this.textAlign].join();
                        ...
                        E(b, {left: l + (this.xCorr || 0) + "px", top: q + (this.yCorr || 0) + "px"});
                        r && (u = b.offsetHeight);
                        this.cTT = p
                    }
                } else this.alignOnAdd = !0
            }, setSpanRotation: function (a, k, e) {
                var c = {}, l = m ? "-ms-transform" : r ? "-webkit-transform" : d ? "MozTransform" : b.opera ? "-o-transform" : "";
        ...
        g(p.prototype, {
            html: function (a, b, e) {
                ...
                c.attr({text: a, x: Math.round(b), y: Math.round(e)}).css({
    ...
    (function (a) {
        var A, y, E = a.createElement, G = a.css, t = a.defined, g = a.deg2rad, d = a.discardElement, m = a.doc, r = a.each, n = a.erase, p = a.extend;
        A = a.extendClass;
        var b = a.isArray, k = a.isNumber, v = a.isObject, B = a.merge;
        y = a.noop;
        var e = a.pick, c = a.pInt, l = a.SVGElement, q = a.SVGRenderer, h = a.win;
        a.svg || (y = {
            docMode8: m && 8 === m.documentMode, init: function (a, c) {
                ...
                var c = this.renderer, b = this.element, e = c.box, h = a && a.inverted, e = a ? a.element || a : e;
                a && (this.parentGroup = a);
                h && c.invertChild(b, e);
                e.appendChild(b);
                this.added = !0;
                ...
                G(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", c, ", M12=", -b, ", M21=", b, ", M22=", c, ", sizingMethod='auto expand')"].join("") : "none"})
                ...
                l && "left" !== l && (this.xCorr -= a * b * (0 > q ? -1 : 1), h && (this.yCorr -= w * b * (0 > d ? -1 : 1)), G(this.element, {textAlign: l}))
                ...
                a ? (b = a.members, n(b, c), b.push(c), c.destroyClip = function () {
                    n(b, c)
                }, a = a.getCSS(c)) : (c.destroyClip && c.destroyClip(), a = {clip: c.docMode8 ? "inherit" : "rect(auto)"});
                return c.css(a)
                ...
                var l = [], q, d = this.element, k = this.renderer, w, n = d.style, r, x = d.path, z, p, v, g;
                ...
                return this
            }, updateShadows: y, setAttr: function (a, c) {
                ...
                E(this.renderer.prepVML(["<", c.split("-")[0], ' opacity="',
                    a, '"/>']), null, null, b)
            }, opacitySetter: y, rotationSetter: function (a, c, b) {
                b = b.style;
                this[c] = b[c] = a;
            ...
            Element: y, isIE8: -1 < h.navigator.userAgent.indexOf("MSIE 8.0"), init: function (a, c, b) {
                ...
                var h = this.createElement(), l = v(a);
                return p(h, {
                    members: [],
                    count: 0,
                    left: (l ? a.x : a) + 1,
                    ...
                    getCSS: function (a) {
                        ...
                        !b && a.docMode8 && "DIV" === f && p(x, {width: c + "px", height: e + "px"});
                        return x
                    },
                ...
                var l = this, q, d = /^rgba/, k, n, p = "none";
                c && c.linearGradient ? n = "gradient" : c && c.radialGradient && (n = "pattern");
                if (n) {
                    var x, z, v = c.linearGradient || c.radialGradient, g, m, L, B, t, Q = "";
                    c = c.stops;
                    var P, Y = [], y = function () {
                    ...
                    if ("fill" === e)if ("gradient" === n)e = v.x1 || v[0] || 0, c = v.y1 || v[1] || 0, g = v.x2 || v[2] || 0, v = v.y2 || v[3] || 0, Q = 'angle="' + (90 - 180 * Math.atan((v - c) / (g - e)) / Math.PI) + '"', y(); else {
                        var p = v.r,
                            A = 2 * p, G = 2 * p, Z = v.cx, aa = v.cy, W = b.radialReference, U, p = function () {
                ...
                1 < arguments.length && l.attr({x: c, y: b, width: e, height: h});
                return l
            }, createElement: function (a) {
                ...
                arc: function (a, c, b, e, h) {
                    var l = h.start, q = h.end, d = h.r || b || e;
                    b = h.innerR;
                    e = Math.cos(l);
                    var k = Math.sin(l), n = Math.cos(q), x = Math.sin(q);
                    if (0 === q - l)return ["x"];
    ...
    (function (a) {
        function A() {
            var m =
                a.defaultOptions.global, r, n = m.useUTC, p = n ? "getUTC" : "get", b = n ? "setUTC" : "set";
        ...
        var y = a.color, E = a.each, G = a.getTZOffset, t = a.merge, g = a.pick, d = a.win;
        a.defaultOptions = {
    ...
    (function (a) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var a = this, n = a.axis, p = n.horiz, b = a.options, k = b.label, v = a.label, g = b.to, e = b.from, c = b.value, l = E(e) && E(g), q = E(c), h = a.svgElem, f = !h, u = [], D, H = b.color, F = m(b.zIndex, 0), t = b.events, u = {"class": "highcharts-plot-" + (l ? "band " : "line ") + (b.className || "")}, C = {}, w = n.chart.renderer, J = l ? "bands" : "lines", M = n.log2lin;
                ...
                if (q)u = n.getPlotLinePath(c, h.strokeWidth()); else if (l)u = n.getPlotBandPath(e, g, b); else return;
                if (f && u && u.length) {
                    if (h.attr({d: u}), t)for (D in b = function (c) {
                        h.on(c, function (b) {
                            t[c].apply(a, [b])
                        })
                    }, t)b(D)
                } else h && (u ? (h.show(), h.animate({d: u})) :
                ...
                var k = this.label, v = this.axis.chart.renderer;
                k || (k = {
                ...
                p = y(b);
                v = y(d);
                k.align(a, !1, {x: p, y: v, width: A(b) - p, height: A(d) - v});
                k.show()
            }, destroy: function () {
        ...
        a.AxisPlotLineOrBandExtension = {
            getPlotBandPath: function (a, d) {
                var p = this.getPlotLinePath(d, null, null, !0), b = this.getPlotLinePath(a, null, null, !0);
                ...
                var p = (new a.PlotLineOrBand(this, d)).render(), b = this.userOptions;
    ...
    (function (a) {
        var A = a.correctFloat, y = a.defined, E = a.destroyObjectProperties, G = a.isNumber, t = a.merge, g = a.pick, d = a.stop, m = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, d = a.options, p = a.chart, b = a.categories, k = a.names, v = this.pos, m = d.labels, e = a.tickPositions, c = v === e[0], l = v === e[e.length - 1], k = b ? g(b[v], k[v], v) : v, b = this.label, e = e.info, q;
                ...
                y(b) ? b && b.attr({text: d}) : (this.labelLength = (this.label = b = y(d) && m.enabled ? p.renderer.text(d, 0, 0, m.useHTML).css(t(m.style)).add(a.labelGroup) : null) && b.getBBox().width, this.rotation = 0)
            }, getLabelSize: function () {
                return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0
            }, handleOverflow: function (a) {
                var d = this.axis, p = a.x, b = d.chart.chartWidth,
                    k = d.chart.spacing, v = g(d.labelLeft, Math.min(d.pos, k[3])), k = g(d.labelRight, Math.max(d.pos + d.len, b - k[1])), B = this.label, e = this.rotation, c = {
                        left: 0,
                        center: .5,
                        right: 1
                    }[d.labelAlign], l = B.getBBox().width, q = d.getSlotWidth(), h = q, f = 1, u, D = {};
                if (e)0 > e && p - c * l < v ? u = Math.round(p / Math.cos(e * m) - v) : 0 < e && p + c * l > k && (u = Math.round((b - p) / Math.cos(e * m))); else if (b = p + (1 - c) * l, p - c * l < v ? h = a.x + h * (1 - c) - v : b > k && (h = k - a.x + h * c, f = -1), h = Math.min(q, h), h < q && "center" === d.labelAlign && (a.x += f * (q - h - c * (q - Math.min(l, h)))), l > h || d.autoRotation && (B.styles ||
                    {}).width)u = h;
                u && (D.width = u, (d.options.labels.style || {}).textOverflow || (D.textOverflow = "ellipsis"), B.css(D))
            }, getPosition: function (a, d, p, b) {
                var k = this.axis, v = k.chart, g = b && v.oldChartHeight || v.chartHeight;
                return {
                ...
                var c = this.axis, l = c.transA, q = c.reversed,
                    h = c.staggerLines, f = c.tickRotCorr || {x: 0, y: 0}, u = k.y;
                ...
                var b = this.axis, k = b.options, v = b.chart.renderer, m = b.horiz,
                    e = this.type, c = this.label, l = this.pos, q = k.labels, h = this.gridLine, f = e ? e + "Tick" : "tick", u = b.tickSize(f), D = this.mark, H = !D, F = q.step, t = {}, C = !0, w = b.tickmarkOffset, J = this.getPosition(m, l, w, n), M = J.x, J = J.y, x = m && M === b.pos + b.len || !m && J === b.pos ? -1 : 1, z = e ? e + "Grid" : "grid", N = k[z + "LineWidth"], O = k[z + "LineColor"], S = k[z + "LineDashStyle"], z = g(k[f + "Width"], !e && b.isXAxis ? 1 : 0), f = k[f + "Color"];
                p = g(p, 1);
                this.isActive = !0;
    ...
    (function (a) {
        var A = a.addEvent, y = a.animObject, E = a.arrayMax, G = a.arrayMin, t = a.AxisPlotLineOrBandExtension, g = a.color, d = a.correctFloat, m = a.defaultOptions, r = a.defined, n = a.deg2rad, p = a.destroyObjectProperties, b = a.each, k = a.error, v = a.extend, B =
            a.fireEvent, e = a.format, c = a.getMagnitude, l = a.grep, q = a.inArray, h = a.isArray, f = a.isNumber, u = a.isString, D = a.merge, H = a.normalizeTickInterval, F = a.pick, I = a.PlotLineOrBand, C = a.removeEvent, w = a.splat, J = a.syncTimeout, M = a.Tick;
        a.Axis = function () {
            this.init.apply(this, arguments)
        };
        a.Axis.prototype = {
            ...
            init: function (a, c) {
                ...
                var h, f = this.options.events;
                -1 === q(this, a.axes) && (b ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
            ...
            defaultLabelFormatter: function () {
                var c = this.axis, b = this.value, f = c.categories, h = this.dateTimeLabelFormat, l = m.lang.numericSymbols, q = l && l.length, d, u = c.options.labels.format, c = c.isLog ? b : c.tickInterval;
                if (u)d = e(u, this); else if (f)d = b; else if (h)d = a.dateFormat(h, b); else if (q && 1E3 <= c)for (; q-- &&
            ...
            getSeriesExtremes: function () {
                ...
                b(a.series, function (b) {
                    if (b.visible || !c.options.chart.ignoreHiddenSeries) {
                        var e = b.options, h = e.threshold, d;
                        a.hasVisibleSeries = !0;
                        a.isLog &&
                        0 >= h && (h = null);
                        if (a.isXAxis)e = b.xData, e.length && (b = G(e), f(b) || b instanceof Date || (e = l(e, function (a) {
                            return f(a)
                        }), b = G(e)), a.dataMin = Math.min(F(a.dataMin, e[0]), b), a.dataMax = Math.max(F(a.dataMax, e[0]), E(e))); else if (b.getExtremes(), d = b.dataMax, b = b.dataMin, r(b) && r(d) && (a.dataMin = Math.min(F(a.dataMin, b), b), a.dataMax = Math.max(F(a.dataMax, d), d)), r(h) && (a.threshold = h), !e.softThreshold || a.isLog)a.softThreshold = !1
                    }
                })
            },
            ...
            getPlotLinePath: function (a,
                                       c, b, e, h) {
                var l = this.chart, d = this.left, q = this.top, u, k, w = b && l.oldChartHeight || l.chartHeight, C = b && l.oldChartWidth || l.chartWidth, p;
                u = this.transB;
            ...
            getLinearTickPositions: function (a,
                                              c, b) {
                var e, h = d(Math.floor(c / a) * a), l = d(Math.ceil(b / a) * a), q = [];
                if (c === b && f(c))return [c];
                for (c = h; c <= l;) {
                    q.push(c);
                    c = d(c + a);
            ...
            getMinorTickPositions: function () {
                var a = this.options, c = this.tickPositions, b = this.minorTickInterval, f = [], e, h = this.pointRangePadding || 0;
                e = this.min - h;
                var h = this.max + h, l = h - e;
                if (l && l / b < this.len / 3)if (this.isLog)for (h = c.length, e = 1; e < h; e++)f = f.concat(this.getLogTickPositions(b, c[e - 1], c[e], !0)); else if (this.isDatetimeAxis && "auto" === a.minorTickInterval)f = f.concat(this.getTimeTicks(this.normalizeTimeTickInterval(b),
                    e, h, a.startOfWeek)); else for (c = e + (c[0] - e) % b; c <= h; c += b)f.push(c);
                0 !== f.length && this.trimTicks(f, a.startOnTick, a.endOnTick);
                return f
            },
            adjustForMinRange: function () {
                var a = this.options, c = this.min, f = this.max, e, h = this.dataMax - this.dataMin >= this.minRange, l, d, q, u, k, w;
            ...
            nameToX: function (a) {
                var c = h(this.categories),
                    b = c ? this.categories : this.names, f = a.options.x, e;
                a.series.requireSorting = !1;
                r(f) || (f = !1 === this.options.nameToX ? a.series.autoIncrement() : q(a.name, b));
                -1 === f ? c || (e = b.length) : e = f;
                this.names[e] = a.name;
                return e
            },
            ...
            setAxisTranslation: function (a) {
                var c = this, f = c.max - c.min, e = c.axisPointRange || 0, h, l = 0, d = 0, q = c.linkedParent, k = !!c.categories, w = c.transA, C = c.isXAxis;
            ...
            setTickInterval: function (a) {
                var e = this, h = e.chart, l = e.options, q = e.isLog, u = e.log2lin, w = e.isDatetimeAxis, C = e.isXAxis, p = e.isLinked, v = l.maxPadding, g = l.minPadding, D = l.tickInterval, n = l.tickPixelInterval, J = e.categories, m = e.threshold, M = e.softThreshold, t, I, y, A;
            ...
            setTickPositions: function () {
                var a = this.options, c, b = a.tickPositions, e = a.tickPositioner, f = a.startOnTick, h = a.endOnTick, l;
            ...
            trimTicks: function (a, c, b) {
                var e = a[0], f = a[a.length - 1], h = this.minPointOffset || 0;
                if (c)this.min = e; else for (; this.min - h > a[0];)a.shift();
                if (b)this.max = f; else for (; this.max + h < a[a.length - 1];)a.pop();
            ...
            alignToOthers: function () {
                ...
                !1 !== this.chart.options.chart.alignTicks && !1 !== e.alignTicks && b(this.chart[this.coll], function (b) {
                    var e = b.options, e = [b.horiz ? e.left : e.top, e.width, e.height, e.pane].join();
            ...
            adjustTickAmount: function () {
                var a = this.tickInterval, c = this.tickPositions, b = this.tickAmount, e = this.finalTickAmt, f = c && c.length;
                if (f < b) {
            ...
            zoom: function (a, c) {
                var b = this.dataMin, e = this.dataMax, f = this.options, h = Math.min(b, F(f.min, b)), f = Math.max(e, F(f.max, e));
            ...
            setAxisSize: function () {
                var a =
                    this.chart, c = this.options, b = c.offsetLeft || 0, e = this.horiz, f = F(c.width, a.plotWidth - b + (c.offsetRight || 0)), h = F(c.height, a.plotHeight), l = F(c.top, a.plotTop), c = F(c.left, a.plotLeft + b), b = /%$/;
            ...
            getThreshold: function (a) {
                var c = this.isLog, b = this.lin2log, e = c ? b(this.min) : this.min, c = c ? b(this.max) : this.max;
            ...
            tickSize: function (a) {
                ...
                "Length"], e = F(c[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
            ...
            getSlotWidth: function () {
                var a = this.chart, c = this.horiz, b = this.options.labels, e = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), f = a.margin[3];
                return c && 2 > (b.step || 0) && !b.rotation &&
                    (this.staggerLines || 1) * a.plotWidth / e || !c && (f && f - a.spacing[3] || .33 * a.chartWidth)
            },
            renderUnsquish: function () {
                var a = this.chart, c = a.renderer, e = this.tickPositions, f = this.ticks, h = this.options.labels, l = this.horiz, d = this.getSlotWidth(), q = Math.max(1, Math.round(d - 2 * (h.padding || 5))), k = {}, w = this.labelMetrics(), C = h.style && h.style.textOverflow, p, v = 0, g, F;
                ...
                if (this.autoRotation)v > q && v > w.h ?
                    k.rotation = this.labelRotation : this.labelRotation = 0; else if (d && (p = {width: q + "px"}, !C))for (p.textOverflow = "clip", g = e.length; !l && g--;)if (F = e[g], q = f[F].label)q.styles && "ellipsis" === q.styles.textOverflow ? q.css({textOverflow: "clip"}) : f[F].labelLength > d && q.css({width: d + "px"}), q.getBBox().height > this.len / e.length - (w.h - w.f) && (q.specCss = {textOverflow: "ellipsis"});
                k.rotation && (p = {width: (v > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight) + "px"}, C || (p.textOverflow = "ellipsis"));
            ...
            getOffset: function () {
                var a = this, c = a.chart, e = c.renderer, f = a.options, h = a.tickPositions, l = a.ticks, d = a.horiz, q = a.side, u = c.inverted ? [1, 0, 3, 2][q] : q, k, w, C = 0, p, v = 0, g = f.title, D = f.labels, n = 0, J = a.opposite, m = c.axisOffset,
                    c = c.clipOffset, H = [-1, 1, 1, -1][q], B, t = f.className, I = a.axisParent, y = this.tickSize("tick");
                k = a.hasData();
                a.showAxis = w = k || F(f.showEmpty, !0);
                a.staggerLines = a.horiz && D.staggerLines;
                a.axisGroup || (a.gridGroup = e.g("grid").attr({zIndex: f.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (t || "")).add(I), a.axisGroup = e.g("axis").attr({zIndex: f.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (t || "")).add(I), a.labelGroup = e.g("axis-labels").attr({zIndex: D.zIndex || 7}).addClass("highcharts-" +
                ...
                }), a.staggerLines && (n *= a.staggerLines, a.labelOffset = n * (a.opposite ? -1 : 1)); else for (B in l)l[B].destroy(), delete l[B];
            ...
            getLinePath: function (a) {
                var c = this.chart, b = this.opposite, e = this.offset, f = this.horiz, h = this.left + (b ? this.width : 0) + e, e = c.chartHeight - this.bottom - (b ? this.height : 0) + e;
                b && (a *= -1);
            ...
            getTitlePosition: function () {
                var a = this.horiz, c = this.left, e = this.top, b = this.len, f = this.options.title, h = a ? c : e, l = this.opposite, d = this.offset, q = f.x || 0, u = f.y || 0, k = this.chart.renderer.fontMetrics(f.style && f.style.fontSize, this.axisTitle).f,
                    b = {
                        ...
                        middle: h + b / 2,
                        high: h + (a ? b : 0)
                    }[f.align], c = (a ? e + this.height : c) + (a ? 1 : -1) * (l ? -1 : 1) * this.axisTitleMargin + (2 === this.side ? k : 0);
                return {
            ...
            render: function () {
                ...
                F && (F[F.isPlaced ? "animate" : "attr"]({d: this.getLinePath(F.strokeWidth())}), F.isPlaced = !0, F[m ? "show" : "hide"](!0));
            ...
            drawCrosshair: function (a, c) {
                var b, e = this.crosshair, f, h = this.cross;
                a || (a = this.cross && this.cross.e);
                this.crosshair && !1 !== (r(c) || !F(e.snap,
    ...
    (function (a) {
        var A = a.Axis, y = a.Date, E = a.defaultOptions, G = a.defined, t = a.each, g = a.extend, d = a.getMagnitude, m = a.getTZOffset, r = a.grep, n = a.normalizeTickInterval, p = a.pick, b = a.timeUnits;
        A.prototype.getTimeTicks =
            function (a, d, n, e) {
                var c = [], l = {}, q = E.global.useUTC, h, f = new y(d - m(d)), u = y.hcMakeTime, D = a.unitRange, H = a.count;
                if (G(d)) {
                ...
                c.info = g(a, {higherRanks: l, totalRange: D * H});
                return c
            };
        A.prototype.normalizeTimeTickInterval = function (a, p) {
            ...
            return {unitRange: c, count: g, unitName: e[0]}
        }
    })(K);
    (function (a) {
        var A = a.Axis, y = a.getMagnitude, E = a.map, G = a.normalizeTickInterval, t = a.pick;
        A.prototype.getLogTickPositions = function (a, d, m, r) {
            var n = this.options, p = this.len, b = this.lin2log, k = this.log2lin, v = [];
            r || (this._minorAutoInterval = null);
            if (.5 <= a)a = Math.round(a), v = this.getLinearTickPositions(a,
                d, m); else if (.08 <= a)for (var p = Math.floor(d), B, e, c, l, q, n = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; p < m + 1 && !q; p++)for (e = n.length, B = 0; B < e && !q; B++)c = k(b(p) * n[B]), c > d && (!r || l <= m) && void 0 !== l && v.push(l), l > m && (q = !0), l = c; else d = b(d), m = b(m), a = n[r ? "minorTickInterval" : "tickInterval"], a = t("auto" === a ? null : a, this._minorAutoInterval, n.tickPixelInterval / (r ? 5 : 1) * (m - d) / ((r ? p / this.tickPositions.length : p) || 1)), a = G(a, null, y(a)), v = E(this.getLinearTickPositions(a, d, m), k), r || (this._minorAutoInterval = a / 5);
            r || (this.tickInterval =
                a);
            return v
        };
    ...
    (function (a) {
        var A = a.addEvent, y = a.dateFormat, E = a.each, G = a.extend, t = a.format, g = a.isNumber, d = a.map, m = a.merge, r = a.pick, n = a.splat, p = a.stop, b = a.syncTimeout, k = a.timeUnits;
        a.Tooltip = function () {
            this.init.apply(this, arguments)
        };
        a.Tooltip.prototype = {
            init: function (a, b) {
                ...
                var l = this, d = l.now, h = !1 !== l.options.animation && !l.isHidden && (1 < Math.abs(a - d.x) || 1 < Math.abs(b - d.y)), f = l.followPointer || 1 < l.len;
                G(d, {
                    x: h ? (2 * d.x + a) / 3 : a,
                    y: h ? (d.y + b) / 2 : b,
                ...
                var e, c = this.chart, l = c.inverted, q = c.plotTop, h = c.plotLeft, f = 0, u = 0, k, p;
                a = n(a);
                e = a[0].tooltipPos;
                ...
                var c = this.chart, l = this.distance, d = {}, h = e.h || 0, f, u = ["y", c.chartHeight, b, e.plotY + c.plotTop, c.plotTop, c.plotTop + c.plotHeight], k = ["x", c.chartWidth, a, e.plotX + c.plotLeft, c.plotLeft, c.plotLeft + c.plotWidth], p = !this.followPointer && r(e.ttBelow, !c.inverted === !!e.negative), g = function (a, c, b, e, f, u) {
                    var k = b < e - l, w = e + l + b < c, C = e - l - b;
                    e += l;
                    if (p && w)d[a] = e; else if (!p &&
                ...
                !1 === k ? this.hide() : (this.isHidden && (p(c), c.attr({
                    opacity: 1,
                    display: "block"
                }).show()), this.split ? this.renderSplit(k, e.hoverPoints) : (c.attr({text: k.join ? k.join("") : k}), c.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + r(a.colorIndex, u.colorIndex)), c.attr({stroke: l.borderColor || a.color || u.color || "#666666"}), this.updatePosition({
                    plotX: d, plotY: h, negative: a.negative, ttBelow: a.ttBelow,
                    h: f[2] || 0
                })), this.isHidden = !1)
            }, renderSplit: function (b, d) {
                var e = this, c = [], l = this.chart, q = l.renderer, h = !0, f = this.options, u;
                E(b.slice(0, b.length - 1), function (a, b) {
                    var k = d[b - 1] || {
                            isHeader: !0,
                            plotX: d[0].plotX
                        }, p = k.series || e, C = p.tt, w = k.series || {}, g = "highcharts-color-" + r(k.colorIndex, w.colorIndex, "none");
                ...
                var b = this.chart, e = this.label, e = (this.options.positioner || this.getPosition).call(this, e.width, e.height, a);
                ...
                var l = e && e.closestPointRange,
                    d, h = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, f, u = "millisecond";
                if (l) {
                    f = y("%m-%d %H:%M:%S.%L", a.x);
                    for (d in k) {
    ...
    (function (a) {
        ...
        a.Pointer.prototype = {
            init: function (a, e) {
                ...
                return r(a, {chartX: Math.round(d), chartY: Math.round(h)})
                ...
                var e = this.chart, q = e.series, h = e.tooltip, f = h ? h.shared : !1, u = !0, k = e.hoverPoint, p = e.hoverSeries, g, n, C, w = [], J;
                ...
                p && (f ? p.noSharedTooltip : p.directTouch) && k ? w = [k] : (f || !p || p.options.stickyTracking || (q = [p]), m(q, function (a) {
                    ...
                    var b = a.distX - c.distX, e = a.dist - c.dist;
                ...
                var e = this.chart, h = e.hoverSeries, f = e.hoverPoint, u = e.hoverPoints, p = e.tooltip, g = p && p.shared ? u : f;
                ...
                var b = this.chart, e = b.options.chart, h = a.chartX, f = a.chartY, d = this.zoomHor, k = this.zoomVert, p = b.plotLeft, g = b.plotTop, n = b.plotWidth, C = b.plotHeight, w, m = this.selectionMarker, v = this.mouseDownX, x = this.mouseDownY, r = e.panKey && a[e.panKey + "Key"];
                ...
                if (this.selectionMarker) {
                    var f = {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, d = this.selectionMarker, k = d.attr ? d.attr("x") : d.x, p = d.attr ? d.attr("y") : d.y, v = d.attr ? d.attr("width") : d.width, B = d.attr ? d.attr("height") : d.height, C;
                    if (this.hasDragged || h)m(e.axes, function (e) {
                        if (e.zoomEnabled && g(e.min) && (h || b[{xAxis: "zoomX", yAxis: "zoomY"}[e.coll]])) {
                            var d = e.horiz, u = "touchend" === a.type ? e.minPixelPadding : 0, q = e.toValue((d ? k : p) + u), d = e.toValue((d ? k + v : p + B) - u);
                            f[e.coll].push({
            ...
            onDocumentMouseMove: function (a) {
                ...
                var b = this.chart, e = b.hoverPoint, h = b.plotLeft, f = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (e && this.inClass(a.target, "highcharts-tracker") ? (n(e.series, "click", r(a, {point: e})), b.hoverPoint && e.firePointEvent("click", a)) : (r(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - h, a.chartY - f) && n(b, "click", a)))
    ...
    (function (a) {
        var A = a.charts, y = a.each, E = a.extend, G = a.map, t = a.noop, g = a.pick;
        E(a.Pointer.prototype, {
            pinchTranslate: function (a, g, r, n, p, b) {
                ...
                var t = this.chart,
                    e = a ? "x" : "y", c = a ? "X" : "Y", l = "chart" + c, q = a ? "width" : "height", h = t["plot" + (a ? "Left" : "Top")], f, u, D = v || 1, H = t.inverted, F = t.bounds[a ? "h" : "v"], I = 1 === g.length, C = g[0][l], w = r[0][l], J = !I && g[1][l], M = !I && r[1][l], x;
                r = function () {
                ...
                var m = this, r = m.chart, n = m.pinchDown, p = a.touches, b = p.length, k = m.lastValidTouch, v = m.hasZoom, B = m.selectionMarker, e = {}, c = 1 === b && (m.inClass(a.target, "highcharts-tracker") && r.runTrackerClick || m.runChartClick), l = {};
                1 < b && (m.initiated = !0);
                ...
                "touchstart" === a.type ? (y(p, function (a, c) {
                    n[c] = {chartX: a.chartX, chartY: a.chartY}
                }), k.x = [n[0].chartX, n[1] && n[1].chartX], k.y = [n[0].chartY,
                    n[1] && n[1].chartY], y(r.axes, function (a) {
                    if (a.zoomEnabled) {
                        var c = r.bounds[a.horiz ? "h" : "v"], b = a.minPixelPadding, e = a.toPixels(g(a.options.min, a.dataMin)), d = a.toPixels(g(a.options.max, a.dataMax)), l = Math.max(e, d);
    ...
    (function (a) {
        var A = a.addEvent, y = a.charts, E = a.css, G = a.doc, t = a.extend, g = a.noop, d = a.Pointer, m = a.removeEvent, r = a.win, n = a.wrap;
        if (r.PointerEvent || r.MSPointerEvent) {
            var p = {}, b = !!r.PointerEvent, k = function () {
                var a, b = [];
                b.item = function (a) {
                    return this[a]
                };
                for (a in p)p.hasOwnProperty(a) && b.push({pageX: p[a].pageX, pageY: p[a].pageY, target: p[a].target});
                return b
            }, v = function (b,
                             e, c, d) {
    ...
    (function (a) {
        var A, y = a.addEvent, E = a.css, G = a.discardElement, t = a.defined, g = a.each, d = a.extend, m = a.isFirefox, r = a.marginNames, n = a.merge, p = a.pick, b = a.setAnimation, k = a.stableSort, v = a.win, B = a.wrap;
        ...
        A.prototype = {
            init: function (a,
                ...
                var b = this.options, d = a.legendItem, h = a.legendLine, f = a.legendSymbol, k = this.itemHiddenStyle.color, b = c ? b.itemStyle.color : k, p = c ? a.color || k : k, g = a.options && a.options.marker, n = {fill: p}, m;
                ...
                var c =
                    this.options, b = c.symbolPadding, c = !c.rtl, d = a._legendItemPos, h = d[0], d = d[1], f = a.checkbox;
                ...
                var c = this.group.alignAttr, b, d = this.clipHeight || this.legendHeight, h = this.titleHeight;
                ...
                var a = this.padding, c = this.options.title, b = 0;
                c.text && (this.title || (this.title = this.chart.renderer.label(c.text, a - 3, a - 4, null, null, null, null, null,
                    "legend-title").attr({zIndex: 1}).css(c.style).add(this.group)), a = this.title.getBBox(), b = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: b}));
                this.titleHeight = b
            }, setText: function (b) {
                var c = this.options;
                ...
                var c = this.chart, b = c.renderer, d = this.options, h = "horizontal" === d.layout, f = this.symbolWidth, k = d.symbolPadding, g = this.itemStyle, m = this.itemHiddenStyle, v = this.padding, r =
                    h ? p(d.itemDistance, 20) : 0, C = !d.rtl, w = d.width, J = d.itemMarginBottom || 0, t = this.itemMarginTop, x = this.initialItemX, z = a.legendItem, B = !a.series, O = !B && a.series.drawLegendSymbol ? a.series : a, y = O.options, y = this.createCheckboxForItem && y && y.showCheckbox, L = d.useHTML;
                z || (a.legendGroup = b.g("legend-item").addClass("highcharts-" + O.type + "-series highcharts-color-" + a.colorIndex + " " + (a.options.className || "") + (B ? "highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = z = b.text("", C ? f + k : -k, this.baseline ||
                ...
                var b = this.chart, d = this.options, h = d.align.charAt(0) + d.verticalAlign.charAt(0) + d.layout.charAt(0);
                ...
                var a =
                    this, c = a.chart, b = c.renderer, p = a.group, h, f, u, n, m = a.box, v = a.options, r = a.padding;
                a.itemX = a.initialItemX;
                a.itemY = a.initialItemY;
                a.offsetWidth = 0;
                a.lastItemY = 0;
                p || (a.group = p = b.g("legend").attr({zIndex: 7}).add(), a.contentGroup = b.g().attr({zIndex: 1}).add(p), a.scrollGroup = b.g().add(a.contentGroup));
                a.renderTitle();
                h = a.getAllItems();
                k(h, function (a, c) {
                ...
                n += r;
                m || (a.box = m = b.rect().addClass("highcharts-legend-box").attr({r: v.borderRadius}).add(p), m.isNew = !0);
                m.attr({
                ...
                f && p.align(d({width: u, height: n}, v), !0, "spacingBox");
                ...
                a > f && !1 !== v.enabled ? (this.clipHeight = n = Math.max(f - 20 - this.titleHeight - t, 0), this.currentPage = p(this.currentPage, 1), this.fullHeight = a, g(z, function (a, c) {
                    var b = a._legendItemPos[1], e = Math.round(a.legendItem.getBBox().height), f = J.length;
                    ...
                    B(n), w || (this.nav = w = d.g().attr({zIndex: 1}).add(this.group), this.up = d.symbol("triangle", 0, 0, C, C).on("click", function () {
                    c.scroll(-1, r)
                    ...
                    c.scroll(1, r)
                }).add(w)), c.scroll(0), a = f) : w && (B(b.chartHeight), w.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                return a
            }, scroll: function (a, c) {
                var d = this.pages, k = d.length, h = this.currentPage +
                    a, f = this.clipHeight, p = this.options.navigation, g = this.pager, n = this.padding;
                h > k && (h = k);
                0 < h && (void 0 !== c && b(c, this.chart), this.nav.attr({
                    translateX: n,
                    translateY: f + this.padding + 7 + this.titleHeight,
                    visibility: "visible"
                }), this.up.attr({"class": 1 === h ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), g.attr({text: h + "/" + k}), this.down.attr({
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function (a, c) {
                var b = a.options, d = b.symbolHeight || a.fontMetrics.f, b = b.squareSymbol;
                ...
                var c = this.options, b = c.marker, d = a.symbolWidth, h = this.chart.renderer, f = this.legendGroup;
    ...
    (function (a) {
        var A = a.addEvent, y = a.animate, E = a.animObject, G = a.attr, t = a.doc, g = a.Axis, d = a.createElement, m = a.defaultOptions, r = a.discardElement, n = a.charts, p = a.css, b = a.defined, k = a.each, v = a.error, B = a.extend, e = a.fireEvent, c = a.getStyle, l = a.grep, q = a.isNumber, h = a.isObject, f = a.isString, u = a.Legend, D = a.marginNames, H = a.merge,
            F = a.Pointer, I = a.pick, C = a.pInt, w = a.removeEvent, J = a.seriesTypes, M = a.splat, x = a.svg, z = a.syncTimeout, N = a.win, O = a.Renderer, S = a.Chart = function () {
        ...
        S.prototype = {
            callbacks: [], getArgs: function () {
                ...
                var c = this.axes, f = this.series, d = this.pointer, h = this.legend, p = this.isDirtyLegend, l, u, g = this.hasCartesianSeries, w = this.isDirtyBox, C = f.length, q = C, n = this.renderer, m = n.isHidden(), v = [];
                ...
                var b = this.axes, c = this.series, e, f;
                ...
                var e = this, f = e.options, d;
                d = f.title = H(f.title, a);
                f = f.subtitle = H(f.subtitle, b);
                k([["title", a, d], ["subtitle", b, f]], function (a,
                                                                   b) {
                    var c = a[0], f = e[c], d = a[1], h = a[2];
                    f && d && (e[c] = f = f.destroy());
                ...
                var b = 0, c, e = this.renderer, f = this.spacingBox;
                k(["title", "subtitle"], function (a) {
                    var c = this[a], h = this.options[a], d;
                ...
                var a = this.options.chart, e = a.width, a = a.height, f = this.renderToClone || this.renderTo;
                ...
                var b, c = this.options, e = c.chart, h, k;
                b = this.renderTo;
                var l = "highcharts-" + a.idCounter++, p;
                ...
                this.container = b = d("div", {id: l}, p, this.renderToClone || b);
            ...
            getMargins: function (a) {
                var c = this.spacing, e = this.margin, f = this.titleOffset;
                this.resetMargins();
                ...
                var e = this, f = e.options.chart, h = e.renderTo, d = b(f.width), k = f.width || c(h, "width"), f = f.height || c(h, "height"), h = a ? a.target : N;
                ...
                h.getChartSize();
                b = d.globalAnimation;
                (b ? y : p)(h.container, {width: h.chartWidth + "px", height: h.chartHeight + "px"}, b);
                h.setChartSize(!0);
                ...
                var b = this.inverted, c = this.renderer, e = this.chartWidth, f = this.chartHeight, h = this.options.chart, d = this.spacing, p = this.clipOffset, l, u, g, w;
                ...
                this.spacingBox = c.spacingBox = {x: d[3], y: d[0], width: e - d[3] - d[1], height: f - d[0] - d[2]};
                this.plotBox = c.plotBox = {x: l, y: u, width: g, height: w};
                ...
                f[J]({x: w / 2, y: w / 2, width: c - w - k % 2, height: e - w - k % 2, r: a.borderRadius});
                J = "animate";
                h || (J = "attr", this.plotBackground = h = b.rect().addClass("highcharts-plot-background").add());
                h[J](v);
                h.attr({fill: u || "none"}).shadow(a.plotShadow);
                g && (p ? p.animate(v) : this.plotBGImage = b.image(g, C, q, n, m).add());
                x ? x.animate({width: r.width, height: r.height}) : this.clipRect = b.clipRect(r);
                J = "animate";
                ...
                d[J](d.crisp({x: C, y: q, width: n, height: m}, -d.strokeWidth()));
                this.isDirtyBox = !1
            }, propFromSeries: function () {
                var a = this, b = a.options.chart, c, e = a.options.series, f, h;
                ...
                b.items && k(b.items, function (c) {
                    var e = B(b.style, c.style), f = C(e.left) + a.plotLeft, h = C(e.top) + a.plotTop + 12;
                    delete e.left;
                    delete e.top;
                ...
                var a = this.axes, b = this.renderer, c = this.options, e, f, h;
                this.setTitle();
                ...
                var b = this, c = b.axes, f = b.series, h = b.container, d, l = h && h.parentNode;
                e(b, "destroy");
                n[b.index] = void 0;
                a.chartCount--;
    ...
    (function (a) {
        ...
        A.prototype = {
            init: function (a, b, d) {
                ...
                var d = this.series, g = d.options.pointValKey || d.pointValKey;
                ...
                var b = {}, k = this.series, g = k.options.keys, n = g || k.pointArrayMap || ["y"], e = n.length, c = 0, l = 0;
                if (m(a) || null === a)b[n[0]] = a; else if (d(a))for (!g &&
                                                                       a.length > e && (k = typeof a[0], "string" === k ? b.name = a[0] : "number" === k && (b.x = a[0]), c++); l < e;)g && void 0 === a[c] || (b[n[l]] = a[c]), c++, l++; else"object" === typeof a && (b = a, a.dataLabels && (k._hasPointLabels = !0), a.marker && (k._hasPointMarkers = !0));
                return b
                ...
                var a =
                    this.series, b = a.zones, a = a.zoneAxis || "y", d = 0, g;
                for (g = b[d]; this[a] >= g.value;)g = b[++d];
                g && g.color && !this.options.color && (this.color = g.color);
                return g
            }, destroy: function () {
                var a = this.series.chart, b = a.hoverPoints, d;
                a.pointCount--;
                ...
                var b = this.series, d = b.tooltipOptions, n = r(d.valueDecimals, ""), m = d.valuePrefix || "", e = d.valueSuffix || "";
                ...
                var g = this, n = this.series.options;
    ...
    (function (a) {
        var A = a.addEvent, y = a.animObject, E = a.arrayMax, G = a.arrayMin, t = a.correctFloat, g = a.Date, d = a.defaultOptions,
            m = a.defaultPlotOptions, r = a.defined, n = a.each, p = a.erase, b = a.error, k = a.extend, v = a.fireEvent, B = a.grep, e = a.isArray, c = a.isNumber, l = a.isString, q = a.merge, h = a.pick, f = a.removeEvent, u = a.splat, D = a.stableSort, H = a.SVGElement, F = a.syncTimeout, I = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            coll: "series",
            init: function (a, b) {
                var c = this, e, f, d = a.series, l = function (a, b) {
                ...
                c.linkedSeries = [];
                c.bindAxes();
                k(c, {name: b.name, state: "", visible: !1 !== b.visible, selected: !0 === b.selected});
                f = b.events;
            ...
            bindAxes: function () {
                var a = this, c = a.options, e = a.chart, f;
            ...
            updateParallelArrays: function (a, b) {
                var e = a.series, f = arguments, h = c(b) ? function (c) {
            ...
            autoIncrement: function () {
                var a = this.options, b = this.xIncrement, c, e = a.pointIntervalUnit, b = h(b, a.pointStart, 0);
            ...
            setOptions: function (a) {
                var b = this.chart, c = b.options.plotOptions, b = b.userOptions || {}, e = b.plotOptions || {}, f = c[this.type];
                this.userOptions = a;
                c = q(f, c.series, a);
            ...
            setData: function (a,
                               f, d, k) {
                var g = this, u = g.points, p = u && u.length || 0, q, m = g.options, r = g.chart, v = null, D = g.xAxis, t = m.turboThreshold, F = this.xData, H = this.yData, B = (q = g.pointArrayMap) && q.length;
                a = a || [];
                q = a.length;
                f = h(f, !0);
                if (!1 !== k && q && p === q && !g.cropped && !g.hasGroupedData && g.visible)n(a, function (a, b) {
                    ...
                    if (t && q > t) {
                        ...
                        if (c(v))for (d = 0; d < q; d++)F[d] = this.autoIncrement(),
                    ...
                    } else for (d = 0; d < q; d++)void 0 !== a[d] && (v = {series: g}, g.pointClass.prototype.applyOptions.apply(v, [a[d]]), g.updateParallelArrays(v, d));
                    l(H[0]) && b(14, !0);
                    g.data = [];
            ...
            processData: function (a) {
                var c = this.xData, e = this.yData, f = c.length, d;
                d = 0;
                var h, k, l = this.xAxis, g, u = this.options;
                g = u.cropThreshold;
                var p = this.getExtremesFromAll || u.getExtremesFromAll, q = this.isCartesian, u = l && l.val2lin, n = l && l.isLog, m, v;
                if (q && !this.isDirty && !l.isDirty && !this.yAxis.isDirty && !a)return !1;
                l && (a = l.getExtremes(), m = a.min, v = a.max);
                if (q && this.sorted && !p && (!g || f > g || this.forceCrop))if (c[f - 1] < m || c[0] > v)c = [], e = []; else if (c[0] < m || c[f - 1] > v)d = this.cropData(this.xData,
            ...
            cropData: function (a, b, c, e) {
                var f = a.length, d = 0, k = f, l = h(this.cropShoulder, 1), g;
                ...
                return {xData: a.slice(d, k), yData: b.slice(d, k), start: d, end: k}
            },
            generatePoints: function () {
                var a =
                    this.options.data, b = this.data, c, e = this.processedXData, f = this.processedYData, d = this.pointClass, h = e.length, k = this.cropStart || 0, l, g = this.hasGroupedData, p, q = [], n;
            ...
            getExtremes: function (a) {
                var b = this.yAxis, f = this.processedXData, d, h = [], k = 0;
                d = this.xAxis.getExtremes();
                var l = d.min, g = d.max, u, p, n, q;
                a = a || this.stackedYData || this.processedYData || [];
                d = a.length;
                for (q = 0; q < d; q++)if (p = f[q], n = a[q], u = (c(n, !0) || e(n)) && (!b.isLog || n.length || 0 < n), p = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (f[q + 1] || p) >= l && (f[q - 1] || p) <= g, u && p)if (u = n.length)for (; u--;)null !== n[u] && (h[k++] = n[u]); else h[k++] = n;
                this.dataMin = G(h);
                this.dataMax = E(h)
            },
            translate: function () {
                ...
                for (var a = this.options, b = a.stacking, e = this.xAxis, f = e.categories, d = this.yAxis, k = this.points, l = k.length, g = !!this.modifyValue, u = a.pointPlacement, p = "between" === u || c(u), n = a.threshold, q = a.startFromThreshold ? n : 0, m, v, D, F, H = Number.MAX_VALUE, a = 0; a < l; a++) {
                    var B = k[a], I = B.x, y = B.y;
                    v = B.low;
                    var A = b && d.stacks[(this.negStacks && y < (q ? 0 : n) ? "-" : "") + this.stackKey], E;
            ...
            setClip: function (a) {
                var b = this.chart, c = this.options, e = b.renderer, f = b.inverted,
                    d = this.clipBox, h = d || b.clipBox, k = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, h.height, c.xAxis, c.yAxis].join(), l = b[k], g = b[k + "m"];
                l || (a && (h.width = 0, b[k + "m"] = g = e.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), b[k] = l = e.clipRect(h), l.count = {length: 0});
            ...
            animate: function (a) {
                var b = this.chart, c = y(this.options.animation), e;
            ...
            drawPoints: function () {
                var a = this.points, b = this.chart, e, f, d, l, g, u, p, n, q = this.options.marker, m, v, r, D =
                    this.markerGroup, t = h(q.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx > 2 * q.radius);
            ...
            pointAttribs: function (a, b) {
                var c = this.options.marker, e = a && a.options, f = e && e.marker || {}, d = c.lineWidth, h = this.color, e = e && e.color, k = a && a.color, l, g;
                ...
                return {stroke: h, "stroke-width": d, fill: l}
            },
            destroy: function () {
                var a = this, b = a.chart, c = /AppleWebKit\/533/.test(I.navigator.userAgent), e, d = a.data || [], h, k, l;
                v(a, "destroy");
                f(a);
            ...
            drawGraph: function () {
                ...
                n(e, function (e, f) {
                    var d = e[0], h = a[d];
                    h ? (h.endX = c.xMap, h.animate({d: c})) : c.length && (a[d] = a.chart.renderer.path(c).addClass(e[1]).attr({zIndex: 1}).add(a.group), h = {
                        stroke: e[2],
            ...
            applyZones: function () {
                var a = this, b = this.chart, c = b.renderer, e = this.zones, f, d, k = this.clips || [], l, g = this.graph, u = this.area, p = Math.max(b.chartWidth, b.chartHeight), q = this[(this.zoneAxis || "y") + "Axis"], m, v, r = b.inverted, D, t, F, H, B = !1;
                e.length && (g || u) && q && void 0 !== q.min && (v = q.reversed, D = q.horiz, g && g.hide(), u && u.hide(), m = q.getExtremes(), n(e, function (e, n) {
                    ...
                    d = Math.min(Math.max(Math.round(q.toPixels(h(e.value, m.max),
                        !0)), 0), p);
            ...
            invertGroups: function (a) {
                function b() {
                    var e = {width: c.yAxis.len, height: c.xAxis.len};
            ...
            plotGroup: function (a, b, c, e, f) {
                var d = this[a], h = !d;
                h && (this[a] = d = this.chart.renderer.g(b).attr({zIndex: e || .1}).add(f), d.addClass("highcharts-series-" + this.index + " highcharts-" + this.type + "-series highcharts-color-" + this.colorIndex + " " +
            ...
            render: function () {
                var a = this, b = a.chart, c, e = a.options, f = !!a.animate && b.renderer.isSVG && y(e.animation).duration, d = a.visible ? "inherit" : "hidden", h = e.zIndex, k = a.hasRendered, l = b.seriesGroup, g = b.inverted;
                c = a.plotGroup("group",
                    "series", d, h, l);
            ...
            redraw: function () {
                var a =
                    this.chart, b = this.isDirty || this.isDirtyData, c = this.group, e = this.xAxis, f = this.yAxis;
                c && (a.inverted && c.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
                }), c.animate({translateX: h(e && e.left, a.plotLeft), translateY: h(f && f.top, a.plotTop)}));
                this.translate();
                this.render();
            ...
            searchPoint: function (a, b) {
                var c = this.xAxis, e = this.yAxis, f = this.chart.inverted;
            ...
            searchKDTree: function (a, b) {
                function c(a, b, k, l) {
                    var g = b.point, u = e.kdAxisArray[k % l], q, n, p = g;
                ...
                var e = this, f = this.kdAxisArray[0], d = this.kdAxisArray[1], h = b ? "distX" : "dist";
    ...
    (function (a) {
        ...
        var y = a.Axis, E = a.Chart, G = a.correctFloat, t = a.defined, g = a.destroyObjectProperties, d = a.each,
            m = a.format, r = a.pick;
        a = a.Series;
        A.prototype = {
            destroy: function () {
                ...
                var d = this.options, b = d.format, b = b ? m(b, this) : d.formatter.call(this);
                ...
                var b = this.axis, k = b.chart, g = k.inverted, m = b.reversed, m = this.isNegative && !m || !this.isNegative && m, e = b.translate(b.usePercentage ?
                    100 : this.total, 0, 0, 0, 1), b = b.translate(0), b = Math.abs(e - b), c = k.xAxis[0].translate(this.x) + a, l = k.plotHeight, m = {
                    x: g ? m ? e : e - b : c,
        ...
        y.prototype.buildStacks = function () {
            var a = this.series, d, b = r(this.options.reversedStacks, !0), k = a.length, g;
            if (!this.isXAxis) {
        ...
        y.prototype.renderStackTotals = function () {
            var a = this.chart, d = a.renderer, b = this.stacks, k, g, m = this.stackTotalGroup;
            m || (this.stackTotalGroup = m =
                d.g("stack-labels").attr({visibility: "visible", zIndex: 6}).add());
        ...
        a.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var a = this.processedXData, d = this.processedYData, b = [], k = d.length, g = this.options, m = g.threshold, e = g.startFromThreshold ? m : 0, c = g.stack, g = g.stacking, l = this.stackKey, q = "-" + l, h = this.negStacks, f = this.yAxis, u = f.stacks, D = f.oldStacks, H, F, I, C, w, y, E;
                f.stacksTouched += 1;
                for (w = 0; w < k; w++)y = a[w], E = d[w], H = this.getStackIndicator(H, y, this.index), C = H.key, I = (F = h && E < (e ? 0 : m)) ? q : l, u[I] || (u[I] =
        ...
        a.prototype.setPercentStacks = function () {
            var a = this, g = a.stackKey, b = a.yAxis.stacks, k = a.processedXData, m;
            d([g, "-" + g], function (d) {
        ...
        a.prototype.getStackIndicator = function (a, d, b) {
            t(a) && a.x ===
            d ? a.index++ : a = {x: d, index: 0};
            a.key = [b, d, a.index].join();
            return a
        }
    })(K);
    (function (a) {
        var A = a.addEvent, y = a.animate, E = a.Axis, G = a.createElement, t = a.css, g = a.defined, d = a.each, m = a.erase, r = a.extend, n = a.fireEvent, p = a.inArray, b = a.isObject, k = a.merge, v = a.pick, B = a.Point, e = a.Series, c = a.seriesTypes, l = a.setAnimation, q = a.splat;
        r(a.Chart.prototype, {
            addSeries: function (a, b, c) {
                var e, d = this;
                a && (b = v(b, !0), n(d, "addSeries", {options: a}, function () {
                    e = d.initSeries(a);
                    d.isDirtyLegend = !0;
                    d.linkSeries();
                    b && d.redraw(c)
            ...
            addAxis: function (a, b, c, e) {
                ...
                a = k(a, {index: this[d].length, isX: b});
                new E(this, a);
                g[d] = q(g[d] || {});
                g[d].push(a);
                v(c, !0) && this.redraw(e)
            ...
            showLoading: function (a) {
                var b = this, c = b.options, e = b.loadingDiv, d = c.loading, g = function () {
                    e && t(e, {
                        left: b.plotLeft + "px",
                        top: b.plotTop + "px",
                ...
                e || (b.loadingDiv = e = G("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, b.container), b.loadingSpan = G("span", {className: "highcharts-loading-inner"},
                    null, e), A(b, "redraw", g));
                setTimeout(function () {
                    e.className = "highcharts-loading"
                });
                b.loadingSpan.innerHTML = a || c.lang.loading;
                t(e, r(d.style, {zIndex: 10}));
                t(b.loadingSpan, d.labelStyle);
                b.loadingShown || (t(e, {
                    opacity: 0,
                    display: ""
                }), y(e, {opacity: d.style.opacity || .5}, {duration: d.showDuration || 0}));
                b.loadingShown = !0;
                g()
            },
            hideLoading: function () {
                var a = this.options, b = this.loadingDiv;
                b && (b.className = "highcharts-loading highcharts-loading-hidden", y(b, {opacity: 0}, {
        ...
        r(B.prototype, {
            update: function (a, c, e, d) {
                ...
                var k = this, l = k.series, q = k.graphic, m, n = l.chart, p = l.options;
                c = v(c, !0);
                !1 === d ? g() : k.firePointEvent("update", {options: a}, g)
            }, remove: function (a, b) {
        ...
        r(e.prototype, {
            addPoint: function (a, b, c, e) {
                var d = this.options, g = this.data, k = this.chart, l = this.xAxis && this.xAxis.names, q = d.data, m, n, p = this.xData, r, t;
                b = v(b, !0);
                m = {series: this};
                ...
                var e = this, g = this.chart, l = this.userOptions, q = this.type, m = a.type || l.type || g.options.chart.type,
                    n = c[q].prototype, p = ["group", "markerGroup", "dataLabelsGroup"], t;
                if (m && m !== q || void 0 !== a.zIndex)p.length = 0;
                d(p, function (a) {
                    p[a] = e[a];
                    delete e[a]
                });
                a = k(l, {animation: !1, index: this.index, pointStart: this.xData[0]}, {data: this.options.data}, a);
    ...
    (function (a) {
        var A = a.color, y =
            a.each, E = a.map, G = a.pick, t = a.Series, g = a.seriesType;
        g("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function () {
                var a = [], g = [], r = this.xAxis, n = this.yAxis, p = n.stacks[this.stackKey], b = {}, k = this.points, v = this.index, t = n.series, e = t.length, c, l = G(n.options.reversedStacks, !0) ? 1 : -1, q, h;
                if (this.options.stacking) {
                    ...
                    y(g, function (f, h) {
                        ...
                        if (b[f] && !b[f].isNull)a.push(b[f]), y([-1, 1], function (a) {
                            var d = 1 === a ? "rightNull" : "leftNull", k = 0, n = p[g[h + a]];
                            ...
                            k = n.toPixels(k, !0);
                            a.push({isNull: !0, plotX: r.toPixels(f, !0), plotY: k, yBottom: k})
                        }
                    })
                }
                return a
                ...
                var g = t.prototype.getGraphPath, r = this.options, n = r.stacking,
                    p = this.yAxis, b, k, v = [], B = [], e = this.index, c, l = p.stacks[this.stackKey], q = r.threshold, h = p.getThreshold(r.threshold), f, r = r.connectNulls || "percent" === n, u = function (b, f, g) {
                        var k = a[b];
                        b = n && l[k.x].points[e];
                        var u = k[g + "Null"] || 0;
                        g = k[g + "Cliff"] || 0;
                        ...
                        void 0 !== m && (B.push({
                            ...
                            isNull: k
                        }), v.push({plotX: c, plotY: null === r ? h : p.getThreshold(r), doCurve: !1}))
                    };
                a = a || this.points;
                ...
                var a = this, g = this.areaPath, r = this.options, n = [["area", "highcharts-area", this.color,
                    r.fillColor]];
                ...
                y(n, function (n) {
                    var b = n[0], k = a[b];
                    k ? (k.endX = g.xMap, k.animate({d: g})) : (k = a[b] = a.chart.renderer.path(g).addClass(n[1]).attr({
    ...
    (function (a) {
        var A = a.seriesTypes.area.prototype, y = a.seriesType;
    ...
    (function (a) {
        var A = a.animObject, y = a.color, E = a.each, G = a.extend, t = a.isNumber, g = a.merge, d = a.pick, m = a.Series, r = a.seriesType, n = a.stop, p = a.svg;
        r("column", "line", {
            borderRadius: 0,
            groupPadding: .2,
            marker: null,
            ...
            getColumnMetrics: function () {
                var a = this, g = a.options, m = a.xAxis, n = a.yAxis, e = m.reversed, c, l = {}, q = 0;
                !1 === g.grouping ? q = 1 : E(a.chart.series, function (e) {
                    var d = e.options, f = e.yAxis, h;
                ...
                var h = Math.min(Math.abs(m.transA) * (m.ordinalSlope || g.pointRange || m.closestPointRange || m.tickInterval || 1), m.len), f = h * g.groupPadding, u = (h - 2 * f) / q, g = Math.min(g.maxPointWidth || m.len, d(g.pointWidth, u * (1 - 2 * g.pointPadding)));
                a.columnMetrics = {
                    width: g,
            ...
            crispCol: function (a, d, g, m) {
                ...
                m -= d;
                l && m && (--d, m += 1);
                return {x: a, y: d, width: g - a, height: m}
            },
            translate: function () {
                ...
                E(a.points, function (q) {
                    var m = d(q.yBottom, c), n = 999 + Math.abs(m), n = Math.min(Math.max(-n, q.plotY), e.len + n), p = q.plotX + u, r = f, t = Math.min(n, m), v, B = Math.max(n, m) - t;
            ...
            pointAttribs: function (a, d) {
                var g = this.options, m, e, c = this.pointAttrToOptions || {};
                e = c.stroke || "borderColor";
                var l = c["stroke-width"] || "borderWidth", q = a && a.color || this.color, h = g[e] || this.color || q, c = g.dashStyle, f;
                ...
                e = {fill: q, stroke: h, "stroke-width": a[l] || g[l] || this[l] || 0};
                g.borderRadius && (e.r = g.borderRadius);
                c && (e.dashstyle = c);
                return e
            },
            drawPoints: function () {
                var a = this, d = this.chart, m = a.options, p = d.renderer, e = m.animationLimit || 250, c;
                E(a.points, function (l) {
                    var q = l.graphic;
                    t(l.plotY) && null !== l.y ? (c = l.shapeArgs, q ? (n(q), q[d.pointCount < e ? "animate" : "attr"](g(c))) : l.graphic = q = p[l.shapeType](c).attr({"class": l.getClassName()}).add(l.group ||
                        a.group), q.attr(a.pointAttribs(l, l.selected && "select")).shadow(m.shadow, null, m.stacking && !m.borderRadius)) : q && (l.graphic = q.destroy())
                })
            },
            animate: function (a) {
                var d = this, g = this.yAxis, m = d.options, e = this.chart.inverted, c = {};
    ...
    (function (a) {
        var A = a.pick, y = a.relativeLength;
    ...
    (function (a) {
        var A = a.addEvent, y = a.defined, E = a.each, G = a.extend, t = a.inArray, g = a.noop, d = a.pick, m = a.Point, r = a.Series, n = a.seriesType, p = a.setAnimation;
        n("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            animate: function (a) {
                var d = this, g = d.points, m = d.startAngleRad;
                a || (E(g, function (a) {
                    var b = a.graphic, g = a.shapeArgs;
                    b && (b.attr({r: a.startR || d.center[3] / 2, start: m, end: m}), b.animate({
                        r: g.r, start: g.start,
                        end: g.end
                    }, d.options.animation))
                }), d.animate = null)
            ...
            updateTotals: function () {
                var a, d = 0, g = this.points, m = g.length, e, c = this.options.ignoreHiddenPoint;
            ...
            translate: function (a) {
                this.generatePoints();
                var g = 0, m = this.options, n = m.slicedOffset, e = n + (m.borderWidth || 0), c, l, q,
                    h = m.startAngle || 0, f = this.startAngleRad = Math.PI / 180 * (h - 90), h = (this.endAngleRad = Math.PI / 180 * (d(m.endAngle, h + 360) - 90)) - f, u = this.points, p = m.dataLabels.distance, m = m.ignoreHiddenPoint, r, t = u.length, y;
            ...
            drawGraph: null,
            drawPoints: function () {
                var a = this, d = a.chart.renderer, g, m, e, c, l = a.options.shadow;
            ...
            init: function () {
                ...
                return a
                                     ...
                                     g) {
                var m = this, n = m.series, e = n.chart, c = n.options.ignoreHiddenPoint;
                g = d(g, c);
                ...
                var d = this.shapeArgs, g = this.series.chart;
    ...
    (function (a) {
        var A = a.addEvent, y = a.arrayMax, E = a.defined, G = a.each, t = a.extend, g = a.format, d = a.map,
            m = a.merge, r = a.noop, n = a.pick, p = a.relativeLength, b = a.Series, k = a.seriesTypes, v = a.stableSort, B = a.stop;
        ...
        b.prototype.drawDataLabels = function () {
            var a = this, b = a.options, d = b.dataLabels, k = a.points, h, f, u = a.hasRendered || 0, p, r, v = n(d.defer,
                !0), y = a.chart.renderer;
            if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), r = a.plotGroup("dataLabelsGroup", "data-labels", v && !u ? "hidden" : "visible", d.zIndex || 6), v && (r.attr({opacity: +u}), u || A(a, "afterAnimate", function () {
                a.visible && r.show(!0);
                r[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), f = d, G(k, function (k) {
                var u, q = k.dataLabel, v, x, F = k.connector, B = !0, A, G = {};
                ...
                if (q && !u)k.dataLabel =
                    ...
                    if (q)E(p) ? (q.attr({text: p}), B = !1) : (k.dataLabel = q = q.destroy(), F && (k.connector = F.destroy())); else if (E(p)) {
                        q = {
        ...
        b.prototype.alignDataLabel = function (a, b, d, g, h) {
            var f = this.chart, k = f.inverted, m = n(a.plotX, -9999), p = n(a.plotY, -9999), r = b.getBBox(), v, y = d.rotation, w = d.align, A = this.visible &&
                (a.series.forceDL || f.isInsidePlot(m, Math.round(p), k) || g && f.isInsidePlot(m, k ? g.x + 1 : g.y + g.height - 1, k)), E = "justify" === n(d.overflow, "justify");
            A && (v = d.style.fontSize, v = f.renderer.fontMetrics(v, b).b, g = t({
                ...
                y: g.y + d.y + {top: 0, middle: .5, bottom: 1}[d.verticalAlign] * g.height
            }, b[h ? "attr" : "animate"](k).attr({align: w}), m = (y + 720) % 360, m = 180 < m && 360 >
            ...
            A || (B(b), b.attr({y: -9999}), b.placed = !1)
        };
        b.prototype.justifyDataLabel = function (a, b, d, g, h, f) {
            var k = this.chart, m = b.align, n = b.verticalAlign, p, r, t = a.box ? 0 : a.padding || 0;
            p =
                d.x + t;
        ...
        k.pie && (k.pie.prototype.drawDataLabels = function () {
            var e = this, c = e.data, g, k = e.chart, h = e.options.dataLabels, f = n(h.connectorPadding, 10), m = n(h.connectorWidth, 1), p = k.plotWidth, r = k.plotHeight,
                t, v = h.distance, C = e.center, w = C[2] / 2, B = C[1], A = 0 < v, x, z, E, K, S = [[], []], L, R, T, Q, P = [0, 0, 0, 0];
            e.visible && (h.enabled || e._hasPointLabels) && (b.prototype.drawDataLabels.apply(e), G(c, function (a) {
                ...
                if ((x = a.dataLabel) && x._pos && a.visible) {
                    ...
                    t[b ? "attr" : "animate"]({d: e.connectorPath(a.labelPos)});
                    t.attr("visibility", T)
            ...
            var b = this.center, d = this.options, g = d.center, h = d.minSize || 80, f, k;
        ...
        k.column && (k.column.prototype.alignDataLabel = function (a, c, d, g, h) {
            var f = this.chart.inverted, k = a.series, p = a.dlBox || a.shapeArgs, r = n(a.below, a.plotY > n(this.translatedThreshold, k.yAxis.len)), t = n(d.inside, !!this.options.stacking);
    ...
    (function (a) {
        var A = a.Chart, y = a.each, E = a.pick, G = a.addEvent;
        A.prototype.callbacks.push(function (a) {
            function g() {
                var d = [];
                y(a.series, function (a) {
                    var g = a.options.dataLabels, n = a.dataLabelCollections || ["dataLabel"];
        ...
        A.prototype.hideOverlappingLabels = function (a) {
            var g = a.length, d, m, r, n, p, b, k, v, B, e = function (a, b, d, e, f, g, k, m) {
            ...
            for (m = 0; m < g; m++)for (r = a[m], d = m + 1; d < g; ++d)if (n = a[d], r && n && r.placed && n.placed && 0 !== r.newOpacity && 0 !== n.newOpacity && (p = r.alignAttr, b = n.alignAttr, k = r.parentGroup, v = n.parentGroup,
    ...
    (function (a) {
        var A = a.addEvent, y = a.Chart, E = a.createElement, G = a.css, t = a.defaultOptions, g = a.defaultPlotOptions, d = a.each, m =
            a.extend, r = a.fireEvent, n = a.hasTouch, p = a.inArray, b = a.isObject, k = a.Legend, v = a.merge, B = a.pick, e = a.Point, c = a.Series, l = a.seriesTypes, q = a.svg;
        a = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                a._hasTracking || (d(a.trackerGroups, function (b) {
                    if (a[b]) {
                        ...
                        a.options.cursor && a[b].css(G).css({cursor: a.options.cursor})
                    }
                }), a._hasTracking = !0)
            }, drawTrackerGraph: function () {
                var a = this, b = a.options, c = b.trackByArea, e = [].concat(c ? a.areaPath : a.graphPath), g = e.length, k = a.chart, m = k.pointer, l = k.renderer, p = k.options.tooltip.snap, r = a.tracker, t, v = function () {
                    if (k.hoverSeries !== a)a.onMouseOver()
                }, y = "rgba(192,192,192," + (q ? 1E-4 : .002) + ")";
                if (g && !c)for (t = g + 1; t--;)"M" === e[t] && e.splice(t + 1, 0, e[t +
                    1] - p, e[t + 2], "L"), (t && "M" === e[t] || t === g) && e.splice(t, 0, "L", e[t - 2] + p, e[t - 1]);
                r ? r.attr({d: e}) : a.graph && (a.tracker = l.path(e).attr({
                    "stroke-linejoin": "round",
        ...
        m(k.prototype, {
            setItemEvents: function (a, b, c) {
                var d = this, e = d.chart, g = "highcharts-legend-" + (a.series ? "point" : "series") + "-active";
        ...
        m(y.prototype, {
            showResetZoom: function () {
                var a = this, b = t.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states, g = "chart" === c.relativeTo ? null : "plotBox";
                ...
                d("xy" === b ? [1, 0] : [1],
                    function (b) {
                        b = c[b ? "xAxis" : "yAxis"][0];
                        var d = b.horiz, e = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", f = c[d], k = (b.pointRange || 0) / 2, m = b.getExtremes(), l = b.toValue(f - e, !0) + k, k = b.toValue(f + b.len - e, !0) - k, f = f > e;
                        b.series.length && (f || l > Math.min(m.dataMin, m.min)) && (!f || k < Math.max(m.dataMax, m.max)) && (b.setExtremes(l, k, !1, !1, {trigger: "pan"}), g = !0);
                        c[d] = e
                    });
                g && c.redraw(!1);
        ...
        m(e.prototype, {
            select: function (a, b) {
                ...
                a = B(a, !c.selected);
                c.firePointEvent(a ?
                    "select" : "unselect", {accumulate: b}, function () {
                ...
                var c = this.series, d = c.chart, e = d.tooltip, g = d.hoverPoint;
                ...
                var c = Math.floor(this.plotX), d = this.plotY, e = this.series,
                    k = e.options.states[a] || {}, l = g[e.type].marker && e.options.marker || {}, n = !1 === l.enabled, p = l.states && l.states[a] || {}, q = !1 === p.enabled, r = e.stateMarkerGraphic, t = this.marker || {}, y = e.chart, A = e.halo;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === k.enabled || a && (q || n && !1 === p.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                    ...
                    if (this.graphic)this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" +
                        ...
                        width: 2 * l,
                        height: 2 * l
                    } : {}, c = v(e.pointAttribs(this, a), c), this.graphic.attr(c), r && r.hide(); else {
                        if (a && p) {
                            p = t.symbol || e.symbol;
                    ...
                    (k = k.halo) && k.size ? (A || (e.halo = A = y.renderer.path().add(y.seriesGroup)),
                        A[b ? "animate" : "attr"]({d: this.haloPath(k.size)}), A.attr({"class": "highcharts-halo highcharts-color-" + B(this.colorIndex, e.colorIndex)}), A.attr(m({
                        fill: this.color || e.color,
                        "fill-opacity": k.opacity,
                        zIndex: -1
                    }, k.attributes))[b ? "animate" : "attr"]({d: this.haloPath(k.size)})) : A && A.attr({d: []});
                    this.state = a
                }
            }, haloPath: function (a) {
                var b = this.series, c = b.chart, d = b.getPlotBox(), e = c.inverted, g = Math.floor(this.plotX);
        ...
        m(c.prototype, {
            onMouseOver: function () {
                ...
                var b = this, c =
                    b.options, e = b.graph, g = c.states, k = c.lineWidth, c = 0;
                a = a || "";
                if (b.state !== a && (d([b.group, b.markerGroup], function (c) {
                        c && (b.state && c.removeClass("highcharts-series-" + b.state), a && c.addClass("highcharts-series-" + a))
                    }), b.state = a, !g[a] || !1 !== g[a].enabled) && (a && (k = g[a].lineWidth || k + (g[a].lineWidthPlus || 0)), e && !e.dashstyle))for (g = {"stroke-width": k}, e.attr(g); b["zone-graph-" + c];)b["zone-graph-" + c].attr(g), c += 1
    ...
    (function (a) {
        var A = a.Chart, y = a.each, E = a.inArray, G = a.isObject, t = a.pick, g = a.splat;
